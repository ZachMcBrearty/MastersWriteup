...
Also in given in Section \ref{sec:Method} are the two habitability functions used throughout this paper.

The 1DEBCM can be used to ...
...
\section{Method} \label{sec:Method} %% move to sec 2, rename to habitability and averaging %%
